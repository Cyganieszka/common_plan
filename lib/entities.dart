...
abstract class Event extends TimeBounded{
  ...
  final bool allDay;
  final bool multiday;
  Event(DateTime from, DateTime to, this.title,this.color) : allDay= "${from.hour}${from.minute}${to.hour}${to.minute}"=="0000", multiday = "${from.year}${from.day}${from.month}"!="${to.year}${to.day}${to.month}" && to.difference(from).inHours>24, super(from, to);
